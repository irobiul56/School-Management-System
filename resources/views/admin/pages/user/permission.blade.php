                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item -> status)
                                                ...
                                                <a class="text-danger" href="{{route('permission.update', $item -> id)}}"><i class="fa fa-times"></i></a>
                                            @else
                                                <span class="badge badge-danger">Unpublished</span>
                                                <a class="text-success" href="{{route('permission.update', $item -> id)}}"><i class="fa fa-check"></i></a>
                                            @endif
