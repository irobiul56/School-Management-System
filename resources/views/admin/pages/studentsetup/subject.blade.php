        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="#" class="btn btn-sm btn-danger">Trash Subject <i class="fa fa-arrow-right"></i></a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item -> status)
                                                ...
                                                <a class="text-danger" href="{{route('student-subject.update', $item -> id)}}"><i class="fa fa-times"></i></a>
                                            @else
                                                <span class="badge badge-danger">Unpublished</span>
                                                <a class="text-success" href="{{route('student-subject.update', $item -> id)}}"><i class="fa fa-check"></i></a>
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-warning" href="{{route('student-subject.edit', $item -> id)}}"><i class="fa fa-edit"></i></a>
                                            {{-- Trash --}}
        ...
        <div class="col-md-4">
            ...
            @if ($form_type == 'create')
                <div class="card">
                    ...
                    <div class="card-body">
                     @include('validate')
                        <form action="{{route('student-subject.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
