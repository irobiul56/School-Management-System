                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item -> status)
                                                ...
                                                <a class="text-danger" href="{{route('student-class.update', $item -> id)}}"><i class="fa fa-times"></i></a>
                                            @else
                                                <span class="badge badge-danger">Unpublished</span>
                                                <a class="text-success" href="{{route('student-class.update', $item -> id)}}"><i class="fa fa-check"></i></a>
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-warning" href="{{route('student-class.edit', $item -> id)}}"><i class="fa fa-edit"></i></a>
                                            {{-- Trash --}}
