        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="#" class="btn btn-sm btn-danger">Trash Designation <i class="fa fa-arrow-right"></i></a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item -> status)
                                                ...
                                                <a class="text-danger" href="{{route('designation.update', $item -> id)}}"><i class="fa fa-times"></i></a>
                                            @else
                                                <span class="badge badge-danger">Unpublished</span>
                                                <a class="text-success" href="{{route('designation.update', $item -> id)}}"><i class="fa fa-check"></i></a>
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-warning" href="{{route('designation.edit', $item -> id)}}"><i class="fa fa-edit"></i></a>
                                            {{-- Trash --}}
