        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4 class="card-title"> Admission Year </h4> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item -> status)
                                                ...
                                                <a class="text-danger" href="{{route('student-year.update', $item -> id)}}"><i class="fa fa-times"></i></a>
                                            @else
                                                <span class="badge badge-danger">Unpublished</span>
                                                <a class="text-success" href="{{route('student-year.update', $item -> id)}}"><i class="fa fa-check"></i></a>
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-warning" href="{{route('student-year.edit', $item -> id)}}"><i class="fa fa-edit"></i></a>
                                            {{-- Trash --}}
