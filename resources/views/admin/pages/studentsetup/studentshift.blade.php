                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item -> status)
                                                ...
                                                <a class="text-danger" href="{{route('student-shift.update', $item -> id)}}"><i class="fa fa-times"></i></a>
                                            @else
                                                <span class="badge badge-danger">Unpublished</span>
                                                <a class="text-success" href="{{route('student-shift.update', $item -> id)}}"><i class="fa fa-check"></i></a>
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-warning" href="{{route('student-shift.edit', $item -> id)}}"><i class="fa fa-edit"></i></a>
                                            {{-- Trash --}}
        ...
        <div class="col-md-4">
            ...
            @if ($form_type == 'create')
                <div class="card">
                    ...
                    <div class="card-body">
                     @include('validate')
                        <form action="{{route('student-shift.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
