                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item -> status)
                                                ...
                                                <a class="text-danger" href="{{route('blogpost.status.update', $item -> id)}}"><i class="fa fa-times"></i></a>
                                            @else
                                                <span class="badge badge-danger">Unpublished</span>
                                                <a class="text-success" href="{{route('blogpost.status.update', $item -> id)}}"><i class="fa fa-check"></i></a>
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            {{-- Trash --}}
                                             ...
                                             <a class="btn btn-sm btn-danger" href="{{route('blogpost.trash', $item -> id)}}"><i class="fa fa-trash"></i></a>
