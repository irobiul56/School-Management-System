...
@section('main-section')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">Edit Tutorial Marks</h3>
                <ul class="breadcrumb">
    ...
    <div class="d-flex justify-content-end">
        <a class="btn btn-info" href="#">Edit Tutorial Marks</a>
    </div>
    <br>
<form action="{{route('tutorial.marks.update')}}" method="POST" enctype="multipart/form-data">                
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card"">
...
<script type="text/javascript">
    $(document).on('click', '#search', function(e) {
        ...
        var tutorial_for_terminal_exam = $('#tutorial_for_terminal_exam').val();



        $.ajax({
                    url:"tutorial-edit-marks",
                    type:"GET",
                    data:{'class_id':class_id, 'year_id':year_id, 'assign_subject_id':assign_subject_id, 'tutorial_for_terminal_exam':tutorial_for_terminal_exam},
                    success:function(data){
                        ...
                        $.each(data, function(key, value){
                            ...
                            '<tr>'+
                                ...
                                '<td><input type="text" class="form-control border border-primary" name="first_tutorial[]" value="'+value.first_tutorial+'"><input type="hidden" name="student_id[]" value="'+value.studentinfo.student_id+'"></td>'+ 
                                '<td><input type="text" class="form-control border border-primary" name="second_tutorial[]" value="'+value.second_tutorial+'"> </td>'+
                                '<td><input type="text" class="form-control border border-primary" name="third_tutorial[]" value="'+value.third_tutorial+'"> </td>'+
