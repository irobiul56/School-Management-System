...
@section('main-section')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">Edit Marks</h3>
                <ul class="breadcrumb">
...
<form action="{{route('student.edit.marks')}}" method="POST" enctype="multipart/form-data">                
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card">
...
<script type="text/javascript">
    $(document).on('click', '#search', function(e) {
        ...
        $.ajax({
                    url:"get-student-edit-marks",
                    type:"GET",
                    data:{'class_id':class_id, 'year_id':year_id, 'assign_subject_id':assign_subject_id, 'exam_type_id':exam_type_id},
                    success:function(data){
                        ...
                        $.each(data, function(key, value){
                            ...
                            '<tr>'+
                                ...
                                '<td><input type="text" class="form-control border border-primary" name="marks[]" value="'+value.marks+'" ></td>'+
