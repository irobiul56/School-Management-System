...
<form action="{{route('marks-management.store')}}" method="POST" enctype="multipart/form-data">                
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                    ...
                    success:function(data){
                        ...
                        $.each(data, function(key, value){
                            ...
                            '<tr>'+
                                ...
                                '<td><input type="text" class="form-control border border-primary" name="marks[]"> </td>'+
