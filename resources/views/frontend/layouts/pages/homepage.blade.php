...
@section('main-section')
 ...
 <section id="slider-part" class="slider-active ">
    <div class="single-slider bg_cover pt-150" style="background-image: url(frontend/pages/images/slider/s-1.jpg)" data-overlay="4">
        <div class="container">
            <div class="row">
        ...
        <div class="row course-slide mt-30">
            <div class="col-lg-4">
                <div class="single-course">
                    <div class="thum">
                        <div class="image">
                            <img src="frontend/pages/images/course/cu-1.jpg" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                    ...
                    <div class="cont">
                        ...
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="#"><img src="frontend/pages/images/course/teacher/t-1.jpg" alt="teacher"></a>
                            </div>
                            <div class="name">
            ...
            <div class="col-lg-4">
                <div class="single-course">
                    <div class="thum">
                        <div class="image">
                            <img src="frontend/pages/images/course/cu-2.jpg" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                    ...
                    <div class="cont">
                        ...
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="#"><img src="frontend/pages/images/course/teacher/t-2.jpg" alt="teacher"></a>
                            </div>
                            <div class="name">
                                <a href="#"><h6>Mark anthem</h6></a>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="single-course">
                    <div class="thum">
                        <div class="image">
                            <img src="frontend/pages/images/course/cu-3.jpg" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                    ...
                    <div class="cont">
                        ...
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="#"><img src="frontend/pages/images/course/teacher/t-3.jpg" alt="teacher"></a>
                            </div>
                            <div class="name">
                                <a href="#"><h6>Mark anthem</h6></a>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="single-course">
                    <div class="thum">
                        <div class="image">
                            <img src="frontend/pages/images/course/cu-4.jpg" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                    ...
                    <div class="cont">
                        ...
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="#"><img src="frontend/pages/images/course/teacher/t-4.jpg" alt="teacher"></a>
                            </div>
                            <div class="name">
                                <a href="#"><h6>Mark anthem</h6></a>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="single-course">
                    <div class="thum">
                        <div class="image">
                            <img src="frontend/pages/images/course/cu-5.jpg" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
...
<section id="video-feature" class="bg_cover pt-60 pb-110" style="background-image: url(frontend/pages/images/bg-1.jpg)">
    <div class="container">
                    ...
                    <ul>
                        <li>
                            <div class="single-feature">
                                <div class="icon">
                                    <img src="frontend/pages/images/all-icon/f-1.png" alt="icon">
                                </div>
                                <div class="cont">
                        ...
                        <li>
                            <div class="single-feature">
                                <div class="icon">
                                    <img src="frontend/pages/images/all-icon/f-2.png" alt="icon">
                                </div>
                                <div class="cont">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="single-teachers mt-30 text-center">
                                <div class="image">
                                    <img src="frontend/pages/images/teachers/t-1.jpg" alt="Teachers">
                                </div>
                                <div class="cont">
                        ...
                        <div class="col-sm-6">
                            <div class="single-teachers mt-30 text-center">
                                <div class="image">
                                    <img src="frontend/pages/images/teachers/t-2.jpg" alt="Teachers">
                                </div>
                                <div class="cont">
                        ...
                        <div class="col-sm-6">
                            <div class="single-teachers mt-30 text-center">
                                <div class="image">
                                    <img src="frontend/pages/images/teachers/t-3.jpg" alt="Teachers">
                                </div>
                                <div class="cont">
                        ...
                        <div class="col-sm-6">
                            <div class="single-teachers mt-30 text-center">
                                <div class="image">
                                    <img src="frontend/pages/images/teachers/t-4.jpg" alt="Teachers">
                                </div>
                                <div class="cont">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-publication mt-30 text-center">
                    <div class="image">
                        <img src="frontend/pages/images/publication/p-1.jpg" alt="Publication">
                        <div class="add-cart">
                            <ul>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-publication mt-30 text-center">
                    <div class="image">
                        <img src="frontend/pages/images/publication/p-2.jpg" alt="Publication">
                        <div class="add-cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-publication mt-30 text-center">
                    <div class="image">
                        <img src="frontend/pages/images/publication/p-3.jpg" alt="Publication">
                        <div class="add-cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-publication mt-30 text-center">
                    <div class="image">
                        <img src="frontend/pages/images/publication/p-4.jpg" alt="Publication">
                        <div class="add-cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
    ...
    <div class="container">
        ...
        <div class="row testimonial-slide mt-40">
            <div class="col-lg-6">
                <div class="single-testimonial">
                    <div class="testimonial-thum">
                        <img src="frontend/pages/images/testimonial/t-1.jpg" alt="Testimonial">
                        <div class="quote">
            ...
            <div class="col-lg-6">
                <div class="single-testimonial">
                    <div class="testimonial-thum">
                        <img src="frontend/pages/images/testimonial/t-2.jpg" alt="Testimonial">
                        <div class="quote">
                            <i class="fa fa-quote-right"></i>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="single-testimonial">
                    <div class="testimonial-thum">
                        <img src="frontend/pages/images/testimonial/t-3.jpg" alt="Testimonial">
                        <div class="quote">
                            <i class="fa fa-quote-right"></i>
                        </div>
                    </div>
        ...
        <div class="row patnar-slide">
            <div class="col-lg-12">
                <div class="single-patnar text-center mt-40">
                    <img src="frontend/pages/images/patnar-logo/p-1.png" alt="Logo">
                </div>
            </div>
            <div class="col-lg-12">
                <div class="single-patnar text-center mt-40">
                    <img src="frontend/pages/images/patnar-logo/p-2.png" alt="Logo">
                </div>
            </div>
            <div class="col-lg-12">
                <div class="single-patnar text-center mt-40">
                    <img src="frontend/pages/images/patnar-logo/p-3.png" alt="Logo">
                </div>
            </div>
            <div class="col-lg-12">
                <div class="single-patnar text-center mt-40">
                    <img src="frontend/pages/images/patnar-logo/p-4.png" alt="Logo">
                </div>
            </div>
            <div class="col-lg-12">
                <div class="single-patnar text-center mt-40">
